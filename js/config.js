...
const TAGS_MAP = {
  ...
  // ── Жанры ────────────────────────────────────
  "Комедия":        { cat: "genre", tip: "Юмор — основа или важная часть" },
  "Хоррор":         { cat: "genre", tip: "Страх, напряжение, атмосфера ужаса" },
  "Триллер":        { cat: "genre", tip: "Саспенс и непредсказуемые повороты" },
  "Детектив":       { cat: "genre", tip: "Расследование и разгадка тайны в центре" },
  "Романтика":      { cat: "genre", tip: "Любовная линия как основа сюжета" },
  "Драма":          { cat: "genre", tip: "Акцент на эмоциях и человеческих конфликтах" },
  "Экшен":          { cat: "genre", tip: "Динамика, сражения, адреналин" },
  "Фэнтези":        { cat: "genre", tip: "Магия, мифология, выдуманные миры" },
  "Sci-Fi":         { cat: "genre", tip: "Наука, технологии, будущее как основа мира" },
  "Киберпанк":      { cat: "genre", tip: "Высокие технологии, низкий уровень жизни" },
  "Постапокалипсис":{ cat: "genre", tip: "Мир после катастрофы" },
  "Исторический":   { cat: "genre", tip: "Реальная историческая эпоха как сеттинг" },
  "Психологический":{ cat: "genre", tip: "Акцент на психике, восприятии, манипуляции" },
  "Военный":        { cat: "genre", tip: "Война как основной контекст" },
  "Спокон":         { cat: "genre", tip: "Спорт и путь к вершине" },
  "Меха":           { cat: "genre", tip: "Гигантские роботы и пилоты" },
  "Сэйнэн":        { cat: "genre", tip: "Для взрослой аудитории, сложные темы" },
  "Сёнэн":         { cat: "genre", tip: "Приключения, дружба, сила воли" },
  "Иммерсивный":    { cat: "genre", tip: "Полностью погружает в свой мир и атмосферу" },
  "Роуд-муви":      { cat: "genre", tip: "Путешествие как метафора или буквальный сюжет" },
  "Биография":      { cat: "genre", tip: "Реальный человек или основано на реальных событиях" },
};
